...
const testimonials = [
  {
    id: 1,
    quote: "Our school's cricket team won the state championship after joining SportEdu!",
...
export default function SportsLandingPage() {
  ...
  return (
    <div className="bg-white overflow-x-hidden">
      ...
      {/* Header */}
      <header className={`fixed w-full z-50 transition-all duration-500 ${isScrolled ? 'bg-white/95 backdrop-blur-xl shadow-xl py-3' : 'bg-transparent py-5'}`}>
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center">
            <div className="flex items-center">
              ...
              <span className="ml-3 text-2xl font-bold bg-gradient-to-r from-emerald-600 to-teal-600 bg-clip-text text-transparent">SportEdu</span>
            </div>
              ...
              {['Explore', 'About', 'Programs', 'Coaches', 'Success', 'Contact'].map((item) => (
                <motion.button
                  ...
                  className={`text-sm font-medium transition-all duration-300 ${
                    activeSection === (item === 'Explore' ? 'explore' : 
                    item === 'About' ? 'about' :
                    item === 'Programs' ? 'programs' :
                    item === 'Coaches' ? 'coaches' :
                    item === 'Success' ? 'success' : 'contact')
                ...
                <div className="flex flex-col space-y-3">
                  {['Explore', 'About', 'Programs', 'Coaches', 'Success', 'Contact'].map((item) => (
                    <motion.button
                      ...
                      className={`text-left py-3 px-4 rounded-xl font-medium ${
                        activeSection === (item === 'Explore' ? 'explore' : 
                        item === 'About' ? 'about' :
                        item === 'Programs' ? 'programs' :
                        item === 'Coaches' ? 'coaches' :
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-8 leading-tight">
                About <span className="bg-gradient-to-r from-emerald-600 to-teal-600 bg-clip-text text-transparent">SportEdu</span>
              </h2>
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                Founded in 2011, SportEdu has been at the forefront of sports education, 
      ...
      <script type="application/ld+json">
        {JSON.stringify({
          ...
          "sameAs": [
            "https://facebook.com/sportedu",
            "https://twitter.com/sportedu",
            "https://instagram.com/sportedu"
          ]
        })}
      </script>
    </div>
